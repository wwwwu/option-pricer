...
# Form implementation generated from reading ui file 'Geometricui.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        Form.setObjectName("Geometric Asian option")
        Form.resize(627, 240)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Geometric Asian option"))
