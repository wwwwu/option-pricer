...
# Form implementation generated from reading ui file 'volatilityui.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        Form.setObjectName("Implied volatility")
        Form.resize(627, 240)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Implied volatility"))
        self.label.setText(_translate("Form", "S(0)"))
        self.label_2.setText(_translate("Form", "premium"))
        self.label_3.setText(_translate("Form", "r"))
        self.label_4.setText(_translate("Form", "q"))
