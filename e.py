...
# Form implementation generated from reading ui file 'eurpeanopui.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        Form.setObjectName("European option")
        Form.resize(665, 255)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "European option"))
